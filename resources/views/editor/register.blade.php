    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center;"><b style="font-size: 19px;">Editor Register</b></div>

                <div class="panel-body">
                    <form name="form" id="form"class="form-horizontal" role="form" method="POST" action="{{ url('admin/register') }}" onsubmit = "return(validate());">
...
<script src="/myJs/registerValidationByJavaScript.js"></script>
