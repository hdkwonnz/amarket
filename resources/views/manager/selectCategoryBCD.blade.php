    ...
    <div class="col-sm-3 col-md-3 col-lg-3">
        ...
        <div style="height: 400px; width: 100%; overflow-y: auto;
            ...
            <div style='margin-top: 5px; margin-left: 10px;'>
                ...
                <a href='#' style='font-size: 20px; float: left;' onclick="selectCategoryACD(<?=$item->categorya_id?>, <?=$item->id?>); return false;">
                    <div class='hoverLightBlue' style='border: 1px solid white; width: 100%; min-height: 30px;'>
                        <?=$item->name?>
                    </div>
                </a>
                <a href="#" class="modifyName" style="float:left; margin-left: 5px;" onclick="modifyCategoryB(<?=$item->categorya_id?>, <?=$item->id?>, '<?=$item->name?>'); return false;">
                    <span>수정</span>
                </a>
                <a href="#" class="deleteName" style="float:left; margin-left: 3px;" onclick="deleteCategoryB(<?=$item->categorya_id?>, <?=$item->id?>, '<?=$item->name?>'); return false;">
                    <span>삭제</span>
                </a>
            </div>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3">
        ...
        <div style="height: 400px; width: 100%; overflow-y: auto;
            ...
            <div style='margin-top: 5px; margin-left: 10px;'>
                ...
                <a href='#' style='font-size: 20px;' onclick="selectCategoryABD(<?=$item->categoryAId?>, <?=$item->categoryBId?>, <?=$item->categoryCId?>); return false;">
                    <div class='hoverLightBlue' style='border: 1px solid white; width: 100%; min-height: 30px;'>
                        <?=$item->name?>
                    </div>
                </a>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3">
        ...
        <div style="height: 400px; width: 100%; overflow-y: auto;
            ...
            <div style='margin-top: 5px; margin-left: 10px;'>
                ...
                <a href='#' style='font-size: 20px;' onclick="selectCategoryABC(<?=$item->categoryAId?>, <?=$item->categoryBId?>, <?=$item->categoryCId?>, <?=$item->categoryDId?>); return false;">
                    <div class='hoverLightBlue' style='border: 1px solid white; width: 100%; min-height: 30px;'>
                        <?=$item->name?>
                    </div>
                </a>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 text-center">
        <div class="inputSection">
            <form action="#" method="post" name="form" id="form">
                ...
                <input type="text" id="txtCategoryB" required />
                <button type="submit" class="buttonB">확인</button>
            </form>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class='form-group'>
                            ...
                            <div class='col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-sm-2 col-md-2 col-lg-2'>
                                <button type='submit' id="create" name="create" class='btn btn-default btn-primary' onclick="updateCategoryB(); return false;">
                                    확인
                                </button>
                            </div>
                        </div>
                ...
                <form name="form" id="form" action="#" method="post" class='form-horizontal' enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class='form-group'>
                            ...
                            <div class='col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-sm-2 col-md-2 col-lg-2'>
                                <button type='submit' id="create" name="create" class='btn btn-default btn-primary' onclick="deleteUpdateCategoryB(); return false;">
                                    확인
                                </button>
                            </div>
                        </div>
...
<script>
    function modifyCategoryB(id, id2, name)
    {
    ...
    function deleteCategoryB(id, id2, name)
    {
    ...
    function updateCategoryB()
    {
        ...
        $.ajax({
            ...
            url: "/manager/updateCategoryB",
            data: { id: id, id2: id2, name: name },
            chche: false,
            ...
            error: function (data) {
                alert("/manager/updateCategoryB 시스템에러...");
            }
        });
    }

    function deleteUpdateCategoryB()
    {
        ...
        $.ajax({
            ...
            error: function (data) {
                alert("/manager/deleteCategoryB 시스템에러...");
            }
        });
    }
</script>
...
<script>
    function selectCategoryBCD(id)
    {
        $.ajax({
            ...
            error: function (data) {
                alert("/admin/selectCategoryBCD 시스템에러...");
            }
        });
    }
...
<script>
    $(function () {
        $('#form').submit(function () {
            var name = $('#txtCategoryB').val().trim();
            if (name.length < 1) {
                alert("한글자 이상 입력하세요...");
                return;
            }
            ...
            $.ajax({
                ...
                url: "/manager/insertCategoryB",
                data: { id: idAjax, txtCategoryB: name },
                chche: false,
                success: function (data) {
                    if (data == 1)
                    {
                ...
                error: function (data) {
                    alert("/manager/insertCategoryB 시스템에러...");
                }
            });
            return false;
