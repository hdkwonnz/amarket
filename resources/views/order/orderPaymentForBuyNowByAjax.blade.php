            ...
            <div class='col-sm-12 col-md-12 col-lg-12'
                ...
                <div class="row">
                    ...
                    <div class='col-sm-4 col-md-4 col-lg-4' style="padding-left: 0px; padding-right: 0px; text-align: right;">
                        ...
                        <span class="originPrice_txt" style="text-decoration: line-through;">
                            <?=$originalPriceByQty?>
                        </span>
                        <span>원</span>
                        @else
                ...
                <div class="row">
                    ...
                    <!--실제판매금액,갯수-->
                    <div class='col-sm-4 col-md-4 col-lg-4' style="padding-left: 0px; padding-right: 0px; text-align: right;">
                        <span class="sellPrice_txt" style="font-size: 18px;">
                            <b>
                                <?=$sellPriceByQty?>
                            </b>
                        </span>
        ...
        <div style="width: 100%; height: auto; font-size: 25px; border-top: 4px solid black; border-bottom: 4px solid black; border-left: 4px solid black; border-right: 4px solid black;">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6-col-lg-6 text-right">
                    <span class="originPriceGrandTotal_txt">
                        <?=$originGrandTotal?>
                    </span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6-col-lg-6 text-right">
                    <span class="grandDiscountedAmount_txt">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6-col-lg-6 text-right">
                    <span class="grandDeliveryCost_txt">
                        <?=$grandDeliveryCost?>
                    </span>
                    <span style="font-size: 15px;">원</span>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6-col-lg-6 text-right">
                    <span class="grandTotalOrderAmount_txt" style="color: red; font-size: 30px;">
