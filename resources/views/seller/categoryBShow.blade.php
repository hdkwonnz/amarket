...
<div class="col-sm-3 col-md-3 col-lg-3">
    ...
    <div style="max-height: 200px; width: 100%; overflow-y: auto;
        ...
        <div style='margin-top: 5px; margin-left: 10px;'>
            <a href='javascript:void()' style='font-size: 20px;' onclick="selectCategoryC(<?=$item->categorya_id?>, <?=$item->id?>, '<?=$item->name?>'); return false;">
...
<script src="/myJs/categoryBShow.js"></script>
