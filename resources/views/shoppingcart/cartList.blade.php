...
<style>
    ...
    #table1 tr{
        line-height: 70px; width: 100%; background-color: rgba(0, 148, 255, 0.13);
    }
    #table1 .td1{
        font-size: 30px; width: 60%; padding-left: 10px;
    }
    #table1 .td2{
        font-size: 20px; width: 10%; color: blue;
    }
    #table1 .td3{
        font-size: 20px; width: 5%; opacity: 0.3;
    }
    #table1 .td4{
        font-size: 20px; width: 10%; opacity: 0.3;
    }
    #table1 .td5{
        font-size: 20px; width: 5%; opacity: 0.3;
    }
    ...
    <table class="webgrid-table" id="checkableGrid">
        <thead>
            <tr class="webgrid-header">
                ...
                <th class="checkbox_width"><input type="checkbox" id="cbSelectAll" />삭제</th>
        ...
        <tbody>
            ...
            <tr class="webgrid-row-style">
                ...
                <td class="price_width">
                    <span style="display: none;" class="originPrice"><?=$originPrice * $item->quantity?></span>
                    <?php               
                    ...
                    <span class="originPrice_txt" style="text-decoration: line-through; font-size: 12px;"></span>원
                        <span style="color: blue;">
                            <?=$discountRate?>%<i class="glyphicon glyphicon-arrow-down" style="font-size: 12px;"></i>
                        </span>
                    <br />
                    <span style="display: none;" class="sellPrice"><?=$sellPrice * $item->quantity?></span>
                    <span class="sellPrice_txt" style="font-size: 20px;"></span>원

                    <!--ProcductId를 Ajax에서 사용하기위하여 save해 놓는다...-->
                    <span style="display: none;" class="productIdxx"><?=$item->product_id?></span>
                    <span style="display: none;" class="cartIdxx"><?=$cartId?></span>                
                </td>
    ...
    <div class="col-sm-4 col-md-4 col-lg-4">
        ...
        <div style="width: 100%; border-top: solid 2px #0026ff; border-bottom: solid 2px #0026ff; border-left: solid 2px #0026ff; border-right: solid 2px #0026ff;">
            ...
            <div class="row" style="font-size: 20px; margin-top: 10px;">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <span style="color: red; font-size: 30px;"><b>x.xxx.xxx.xx</b></span>
                </div>
            </div>
        </div>
    </div>
