...
<div class="row" style="margin-right: 30px;">
    <div class='col-sm-12 col-md-12 col-lg-12'
        ...
        <div class='col-sm-5 col-md-5 col-lg-5'>
            <span style="font-size: 20px; color: #0026ff">장바구니</span>
...
<div class="display_section">
    ...
    <div class='col-sm-12 col-md-12 col-lg-12' style="padding-left: 0px; text-align: center;">
        <!--ajax 사용을 위해 숨긴다-->
        <div class="number_of_rows" style="display: none;">
            <?=$numRows?>
        </div>
        <?php
    if ($numRows < 1)
